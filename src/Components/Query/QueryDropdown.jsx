...
function QueryDropdown() {
    ...
    return (
        <div className="w-full h-[100vh] bg-black border-t-4 border-gray-200 flex justify-center items-center">
            <div className="w-4/5 h-fit py-20 bg-transparent">
                <h1 className="font-extrabold text-7xl text-gray-50 text-center">Frequently Asked Questions</h1>
                ...
                <div onClick={() => toggleVisibility(1)} className="w-full h-fit bg-zinc-600 px-10 py-6 text-white text-semibold tex-xl flex *
                ...
                <div  onClick={() => toggleVisibility(2)} className="w-full h-fit bg-zinc-600 px-10 py-6 text-white text-semibold tex-xl flex *
                 justify-between items-center">Where can I watch? <i className={`fa-solid fa-plus transform ${visibility
                    [2] ? 'rotate-45' : ''}`}></i></div>
                ...
                <div onClick={() => toggleVisibility(3)} className="w-full h-fit bg-zinc-600 px-10 py-6 text-white text-semibold tex-xl flex *
               ...
               <div className={`faq-answer py-3 px-4 transition-all duration-500 bg-zinc-600 ${visibility
                ...
                <div  onClick={() => toggleVisibility(4)} className="w-full h-fit bg-zinc-600 px-10 py-6 text-white text-semibold tex-xl flex *
                ...
                <div  onClick={() => toggleVisibility(5)} className="w-full h-fit bg-zinc-600 px-10 py-6 text-white text-semibold tex-xl flex *
